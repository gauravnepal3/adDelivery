...
public class CampaignCacheService {
    ...
    /**
     * If rank is only by biddingRate, re-adding is enough to ensure presence.
     * Call this after serving to keep the (country,language,os,browser) key hot.
     */
    ...
    /**
     * Server-side random tie-break among all top-scored members (Lua; one round-trip).
     * Returns the selected campaignId or null.
     */
